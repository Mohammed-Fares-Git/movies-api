...
public class MoviesApiApplication {
	...
	public CommandLineRunner comandlineRunner(MovieServiceImpl movieServiceImpl) {
		return (e)->{
			...
			movieServiceImpl.insertMovie(new Movie("Taylor Swift: The Eras Tour", "Experience the Eras Tour concert, performed by the one and only Taylor Swift.", 9.99f, "https://cdn.shopify.com/s/files/1/0057/3728/3618/products/53057_500x749.jpg?v=1604088239", "2003"));
